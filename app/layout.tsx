...
export const metadata: Metadata = {
  title: "Asjiad Farooq | Global Marketing & Growth",
  description:
    "Asjiad Farooq helps ambitious brands grow — strategic marketing, creative execution, and measurable results from insight to impact.",
};
